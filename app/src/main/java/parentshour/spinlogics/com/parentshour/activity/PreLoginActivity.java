...
public class PreLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView parentImageButton, assistantImageButton;
    Context mContext;
    ...
    private void initializeControls() {
        parentImageButton = (TextView) findViewById(R.id.ib_parent);
        assistantImageButton = (TextView) findViewById(R.id.ib_assistant);
    }
